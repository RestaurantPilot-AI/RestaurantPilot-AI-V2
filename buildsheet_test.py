...
def run_pipeline():
    ...
    for file_path in STAGING_DIR.iterdir():
        ...
        try:
            buildsheet_df = extract_buildsheet(temp_restaurant_id, file_path)
        ...
        # Save using DataFrame-only signature; save_buildsheet_db will use restaurant_id inside df
        bs = db.save_buildsheet_db(buildsheet_df)
